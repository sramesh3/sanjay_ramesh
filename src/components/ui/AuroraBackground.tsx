...
export const AuroraBackground = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-screen w-full flex-col items-center justify-center bg-zinc-50 text-slate-950 dark:bg-zinc-900",
        className
      )}
      {...props}
    >
          ...
          className={cn(
            `after:animate-aurora pointer-events-none absolute -inset-[10px]
             ...
             [--white-gradient:repeating-linear-gradient(100deg,
               ...
               var(--transparent)_12%,
               var(--white)_16%)]
             after:absolute after:inset-0 after:
            ...
            showRadialGradient &&
              `[mask-image:radial-gradient(ellipse_at_100%_0%,
                black_10%,transparent_70%)]`
          )}
        />
      </div>
      {children}
